...
// pub struct GPT3CompletionOptions {
//     pub temperature: f32,
//     pub tokens: u16,
...
// impl GPT3CompletionOptions {
//     pub fn default() -> GPT3CompletionOptions {
//         GPT3CompletionOptions {
//             temperature: 0.7,
//             tokens: 256,
//             stop_sequences: vec![],
//             top_p: 1.0,
...
//     pub fn with_tokens(num_tokens: u16) -> GPT3CompletionOptions {
//         GPT3CompletionOptions {
//             temperature: 0.7,
//             tokens: num_tokens,
//             stop_sequences: vec![],
...
impl GPT3 {
    ...
    // pub fn completion(&self, input_text: String, options: Option<&GPT3CompletionOptions>) -> Result<Option<String>> {
    pub fn completion(&self, input_text: String) -> Result<Option<String>> {
